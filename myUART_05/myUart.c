...
// The following structure will configure the EUSCI_A port to run at 57600 baud from an 8MHz SMCLK
...
EUSCI_A_UART_initParam myUart_Param_115200_8N1_SMCLK8MHz = {
...
EUSCI_A_UART_initParam myUart_Param_57600_8N1_SMCLK8MHz = {
    EUSCI_A_UART_CLOCKSOURCE_SMCLK,
    8,                                                                          // clockPrescalar
    10,                                                                         // firstModReg
    247,                                                                          // secondModReg
...
EUSCI_A_UART_initParam myUart_Param_57600_8N1_SMCLK1MHz = {
    EUSCI_A_UART_CLOCKSOURCE_SMCLK,
    17,                                                                          // clockPrescalar
    0,                                                                         // firstModReg
    74,                                                                          // secondModReg
...
int myUart_readBuf( uint16_t myUart_Instance, unsigned char *rxBuf, uint16_t *rxSize )
{
  ...
  uint16_t      rxBufLen = 0;                                                   // Current length of input buffer
    ...
    {
        // We 'm1issed' reading the data in time if RxRDY ever goes above '1'
